...
let squirtleEnemigo = new Dayamon('Squirtle', 'https://64.media.tumblr.com/ca7bd49d1d414f1ccdaa4950094b6754/tumblr_n28v8gQLkH1rcgdmto3_250.gifv', 5, './assets/Squirtle.png')
let charmanderEnemigo = new Dayamon('Charmander', 'https://64.media.tumblr.com/6035bf1768e0c05901193ac1129df39d/tumblr_n28v8gQLkH1rcgdmto2_250.gifv', 5, './assets/Charmander.png')
let bulbasaurEnemigo = new Dayamon('Bulbasaur', 'https://64.media.tumblr.com/4a724672ff10c9886c94434a00954a99/tumblr_n28v8gQLkH1rcgdmto1_250.gifv', 5, './assets/Bulbasaur.png')
...
function revisarVidas() {
     if (victoriasJugador === victoriasEnemigo) { crearMensajeFinal("Esto fue un empate!!!") } else if (victoriasJugador > victoriasEnemigo) { crearMensajeFinal("FELICITACIONES! Ganaste :)") } else { crearMensajeFinal('Lo siento, perdiste :(') } 
}
...
function pintarCanvas(){
   ...
   squirtleEnemigo.pintarDayamon()
   charmanderEnemigo.pintarDayamon()
   bulbasaurEnemigo.pintarDayamon()
