...
function seleccionarMascotaJugador() {
    ...
    if (inputSquirtle.checked) {
        ...
        imagenJugadorSeleccion.innerHTML=`<img src=${charmander.foto} alt=${charmander.nombre} >`
    } else if (inputBulbasaur.checked) {
        spanMascotaJugador.innerHTML = inputBulbasaur.id
        mascotaJugador = inputBulbasaur.id
        imagenJugadorSeleccion.innerHTML=`<img src=${bulbasaur.foto} alt=${bulbasaur.nombre} >`
...
function seleccionarMascotaEnemigo() {
    ...
    imagenEnemigoSeleccion.innerHTML=`<img src=${dayamones[mascotaAleatoria].foto} alt=${dayamones[mascotaAleatoria].nombre} >`
    secuenciaAtaque()
}
